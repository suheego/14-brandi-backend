...
class ProductManageSearchView(MethodView):
    ...
    @validate_params(
        ...
        Param('seller_attribute_type_id', GET, int, required=False, rules=[Enum(1, 2, 3, 4, 5, 6, 7)]),
        Param('is_sale',                  GET, int, required=False, rules=[Enum(0, 1)]),
        Param('is_display',               GET, int, required=False, rules=[Enum(0, 1)]),
        Param('is_discount',              GET, int, required=False, rules=[Enum(0, 1)]),
    ...
    def get(self, *args):
        ...
        try:
            data = {
                ...
                'seller_attribute_type_id' : request.args.get('seller_attribute_type_id', None),
...
class ProductManageDetailView(MethodView):
    ...
    @validate_params(
        Param('product_code', PATH, str, required=True, rules=[MaxLength(20)]),
    )
    def get(self, *args):
        ...
        try:
            ...
            result = self.service.detail_product_service(connection, product_code)
