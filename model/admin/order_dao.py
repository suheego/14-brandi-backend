...
class OrderDao:
    ...
    def get_product_prepare_dao(self, connection, data):
        total_count_sql = """
    ...
    def get_shipping_dao(self, connection, data):
        total_count_sql = """
            SELECT COUNT(*) AS total_count
        """
    ...
    def get_complete_delivery_dao(self, connection, data):
        total_count_sql = """
            SELECT COUNT(*) AS total_count
        """
    ...
    def get_confirmed_purchase_dao(self, connection, data):
        total_count_sql = """
            SELECT COUNT(*) AS total_count
        """
